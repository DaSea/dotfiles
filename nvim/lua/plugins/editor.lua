...
return {
    ...
    -- 类似quicklist, locallist等，但是更美观
    {
		...
		-- stylua: ignore
		keys = {
			{ '<leader>kx', function() require('trouble').toggle() end, desc = '[Trouble]Document Diagnostics' },
			{ '<leader>kw', function() require('trouble').toggle('workspace_diagnostics') end, desc = '[Trouble]Workspace Diagnostics' },
			{ '<leader>kz', function() require('trouble').toggle('document_diagnostics') end, desc = '[Trouble]Document Diagnostics' },
			{ '<leader>kq', function() require('trouble').toggle('quickfix') end, desc = '[Trouble]Quickfix List' },
			{ '<leader>kl', function() require('trouble').toggle('loclist') end, desc = '[Trouble]Location List' },
    ...
    -- search/replace in multiple files
    {
		...
		-- stylua: ignore
		keys = {
			{ '<Leader>sp', function() require('spectre').toggle() end, desc = '[Search]Spectre-in multi file', },
			{ '<Leader>sp', function() require('spectre').open_visual({ select_word = true }) end, mode = 'x', desc = '[Search]Spectre Word' },
		},
        opts = {
